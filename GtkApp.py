...
class App(Gtk.Application):
    def __init__(self, save_building_callback, save_scenario_callback, open_callback, create_circuit_callback,
                 delete_circuit_callback, create_detector_callback, delete_detector_callback, edit_detector_callback,
                 edit_building_callback, **kwargs):
        ...
        data_action_entries = [("save_building", save_building_callback, None),
                               ("save_scenario", save_scenario_callback, None),
                               ("open", open_callback, None),
                               ("edit_mode", None, None, "false", self.on_edit_mode_clicked)]

        edit_action_entries = [("create_circuit", create_circuit_callback, None),
                               ("delete_circuit", delete_circuit_callback, "i"),
                               ("create_detector", create_detector_callback, "i"),
                               ("delete_detector", delete_detector_callback, "s"),
                               ("edit_detector", edit_detector_callback, "s"),
                               ("edit_building", edit_building_callback, None)]
        ...
        self.window = MainWindow(data_action_group=self.data_action_group, edit_action_group=self.edit_action_group)
    ...
    def show_save_dialog(self, save_response_callback, file_type):
        ...
        file_save_dialog.save(self.window, None, partial(save_response_callback, file_type))
    ...
    def add_detector(self, circuit_number: int, detector_number: int, on_toggled_callback,
                     alarm_status: bool = False) -> None:
        """Create a new Detector instance and add it to the window."""
        detector = Detector(circuit_number, detector_number)
        self.circuit_dict[circuit_number].detector_dict = detector
