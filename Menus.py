...
class DetectorContextMenu(Gio.Menu):
    ...
    def __init__(self, circuit_number, detector_number):
        ...
        disable_detector_item = Gio.MenuItem.new("Abschaltung", "edit.disable_detector")
        disable_detector_item.set_attribute_value("target", GLib.Variant("s", f"{circuit_number}, {detector_number}"))
